    ...
    return (
      <>    
        <div className="container lg:mx-auto lg:min-h-50vh h-screen">
            <div class="grid grid-cols-4 gap-4 my-4 bg-gray-100 p-2">
                <div className="flex flex-row gap-4">
                    ...
                    <p className="font-bold">Cancelado</p>
                </div>
                <div className="flex flex-row gap-4">
                ...
                <div className="flex flex-row gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 text-orange-500">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6Z" />
                    </svg>
                ...
                <div className="flex flex-row gap-4">
                    ...
                    <p className="font-bold">Concluido</p>
                </div>
            </div>
            <nr className="my-4" />
            <div class="grid grid-cols-4 gap-4 my-4">
                <div className="shadow-md p-4">
                    ...
                    <div className="text-center">
                        <p className="font-bold text-lg">Aniversário</p>
                    </div>
                </div>
                <div className="shadow-md p-4">
                    <div className="flex justify-between">
                    ...
                    <hr className="m-4" />
                    <div className="text-center">
                        <p className="font-bold text-lg">Graduação</p>
                    </div>
                </div>
                <div className="shadow-md p-4">
                     <div className="flex justify-between">
                    ...
                    <hr className="m-4" />
                    <div className="text-center">
                        <p className="font-bold text-lg">Despedida de Solteiro</p>
                    </div>
                </div>
                <div className="shadow-md p-4">
                    <div className="flex justify-between">
                    ...
                    <hr className="m-4" />
                    <div className="text-center">
                        <p className="font-bold text-lg">Lobolo</p>
                    </div>
                </div>
            </div>
        </div>   
