        ...
        <div className="h-screen">
          <div className="flex flex-row justify-between mb-1 mt-4">
            <div className="flex flex-row gap-2">
              ...
              <h3>Partilhar a organização do Evento</h3>
            </div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div className="flex flex-row justify-center gap-2 mt-4">
            ...
            <div className="absolute right-52 z-10">
              {toggleDropdown ? (
                <>
                  <div className="w-96 bg-sky-400 rounded-lg p-4">
                    <div className="flex flex-row justify-between text-white">
                      <div>Planificação</div>
                      <div className="flex flex-row justify-between text-sm w-48">
                        <div>
                          <input
                            key={"Editar1"}
                  ...
                  <table className="min-w-full text-center text-sm font-light">
                    ...
                    <tbody>
                      <tr className="border-b dark:border-neutral-500">
                        ...
                        <td className="whitespace-nowrap  px-6 py-4">Anjos</td>
                        <td className="whitespace-nowrap  px-6 py-4">d</td>
                        <td className="whitespace-nowrap  px-6 py-4">
                          Presencial
                        </td>
