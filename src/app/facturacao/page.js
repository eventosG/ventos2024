  ...
  return (
    <>
      <div className="container lg:mx-auto lg:min-h-50vh h-screen">
        ...
        <hr className="my-2" />
        <div className="my-4 bg-blue-100/20">
                  ...
                  <table className="min-w-full text-center text-sm font-light">
                    <thead className="border-b bg-neutral-800 font-medium text-white dark:border-neutral-500 dark:bg-neutral-900">
                      <tr>
                        <th
                          scope="col"
                          className=" px-6 py-4 flex justify-start w-12"
                        >
                          #
                        </th>
                    ...
                    <tbody>
                      <tr className="border-b dark:border-neutral-500">
                        <td className="whitespace-nowrap  px-6 py-4 font-medium flex justify-start w-12">
                          1
                        </td>
                        <td className="whitespace-nowrap  px-6 py-4  w-96">
                        ...
                        <td className="whitespace-nowrap  px-6 py-4 cursor-pointer flex justify-end">
                          0.00
                        </td>
                      </tr>
                      <tr className="border-b dark:border-neutral-500">
          ...
          <div className="flex justify-end">
            <div>
              <p className="font-bold flex justify-end px-4">
                Soma dos Impostos
              </p>
              ...
              <p className="font-bold flex justify-end px-4 text-2xl my-8">
                Total: 0.00
              </p>
            </div>
          </div>
